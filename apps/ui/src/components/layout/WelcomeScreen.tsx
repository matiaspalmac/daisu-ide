...
export function WelcomeScreen(): JSX.Element {
  ...
  return (
    <section className="h-full grid place-items-center bg-[var(--bg-base)] overflow-auto">
      <div className="flex flex-col items-center gap-12 max-w-3xl py-12">
        <div className="grid grid-cols-3 gap-4">
          {cards.map((c) => (
            <button
              ...
              className="relative w-44 h-32 bg-[var(--bg-elevated)] border border-[var(--border-subtle)] rounded-[var(--radius-md)] p-4 flex flex-col items-center justify-center gap-2 hover:border-[var(--border-strong)] hover:shadow-[var(--glow-cyan-sm)] transition-all"
            >
              ...
              <c.Icon size={28} strokeWidth={1.2} className="text-[var(--fg-secondary)]" />
                ...
                <button
                  ...
                  className={
                    ...
                    (i === tipIdx
                      ...
                      : "bg-[var(--fg-muted)]/40 hover:bg-[var(--fg-muted)]")
                  }
                />
              ))}
            </div>
